                          ...
                          <select
                            ...
                            onChange={(e) => {
                              ...
                              if (prod) {
                                ...
                                addToast(`Auto-filled details from "${prod.name}"!`, 'success')
                              }
                            }}
                            className="w-full bg-white border border-blue-300 text-slate-900 text-xs font-semibold rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:outline-none shadow-xs cursor-pointer"
                          >
